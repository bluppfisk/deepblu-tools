...
class DeepbluLog:
    def __init__(self, json_log, media):
        ...
        self.min_temp = DeepbluTools.convert_temp(
            json_log.get("diveMinTemperature", None)
        )
        self.max_depth = DeepbluTools.get_depth(
        ...
        self.average_depth = DeepbluTools.get_depth(
...
class WayPoint:
    def __init__(self, way_point, root, parent):
        ...
        depth = DeepbluTools.get_depth(
            way_point.get("pressure"), air_pressure, water_type
        )
        ...
        self.temp = DeepbluTools.convert_temp(
